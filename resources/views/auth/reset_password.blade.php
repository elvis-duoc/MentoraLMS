    ...
    <body>
        ...
        <div class="main-container">
            <div class="login-card">
                ...
                <form method="POST" action="{{ route('student.store-reset-password', $user->forget_password_token) }}">
                    @csrf
                    <input type="hidden" value="{{ $user->email }}" name="email">

                    <div class="password-container">
                        <input class="form-input" type="password" name="password" id="password-field" placeholder="{{ __('translate.Password') }} *">
                        <i class="fas fa-eye-slash toggle-password" id="togglePassword"></i>
                    </div>

                    <div class="password-container">
                        <input class="form-input" type="password" name="password_confirmation" id="password-confirmation-field" placeholder="{{ __('translate.Confirm Password') }} *">
